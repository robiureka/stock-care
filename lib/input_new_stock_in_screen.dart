...
class _InputNewStockInScreenState extends State<InputNewStockInScreen> {
  ...
  int? _outflows, _quantity = 0, _price = 0, _expectedProfitPerItem;
  @override
  void initState() {
    super.initState();
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    onChanged: (String? value) {
                      setState(() {
                        _expectedProfitPerItem = int.parse(value!);
                      });
                    },
                    decoration: InputDecoration(
                      hintText: 'Keuntungan Per Satuan',
                      contentPadding:
                          EdgeInsets.symmetric(vertical: 8.0, horizontal: 10.0),
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10.0),
                    ...
                    validator: (String? value) {
                      if (value == '' || value!.isEmpty) {
                        return 'Mohon isi Keuntungan Per Satuan';
                      }
                    },
                  ),
                  SizedBox(
                            ...
                            if (_inputNewStockInGlobalKey.currentState!
                              ...
                              try {
                                ...
                                await appState.addStockAvailableFirestore(
                                    ...
                                    stockCode: _stockCode,
                                    expectedIncome:
                                        (_price! + _expectedProfitPerItem!) * _quantity!,
                                    quantity: _quantity,
